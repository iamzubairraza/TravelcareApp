            ...
            <ScrollView
                ...
                <View style={styles.drawerContainer}>
                    ...
                    <DrawerItem
                        ...
                        onPress={() => {
                            this.navigateTo('ProfileSetting', { isModeEdit: true, userType: COMPANY })
                        }}
                    />
                    <DrawerItem
                        title={'Manage Offers'}
                        onPress={() => {
                            this.navigateTo('ManageOffersScreen')
                        }}
                    />
                    <DrawerItem
                        title={'All Travelers'}
                        onPress={() => {
                            this.navigateTo('TravelerListScreen', { traveler: "all" })
                        }}
                    />
                    <DrawerItem
                        title={'Top Travelers'}
                        onPress={() => {
                            this.navigateTo('TravelerListScreen', { traveler: "top" })
                        }}
                    />
                    <DrawerItem
                        title={'All Jobs'}
                        onPress={() => {
                            this.navigateTo('AllJobsScreen')
                        }}
                    />
                    <View style={{ flex: 1 }} />
                    <DrawerItem
